...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Question/</span> Edit
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action ="/questions/{{ $question->id }}" method="post" enctype="multipart/form-data">
                            ...
                            @method("put")
                            <div class="mb-3">
                                <label class="form-label" for="basic-icon-default-question">Question</label>
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-question2" class="input-group-text"><i
                                            class="bx bx-buildings"></i></span>
                                    <input type="text" id="basic-icon-default-question" class="form-control"
                                        placeholder="Enter question Name" aria-label="question"
                                        aria-describedby="basic-icon-default-question2" name="title" value="{{ $question->title }}"/>
                        ...
                        <select id="semester_id" class="form-select" name="semester_id" required>
                          ...
                          <option value={{ $sem->id }} {{$sem->title == $question->semester->title?"selected":"" }}>{{ $sem->title }}</option>
                          @endforeach
