...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Notes/</span> Create
            ...
            <div class="col-xl-8 mx-auto">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Create A New Notes</h5>
                    </div>
                    <div class="card-body">
                        <form action ="/notes" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label" for="basic-icon-default-notes">Notes</label>
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-notes2" class="input-group-text"><i
                                            class="bx bx-buildings"></i></span>
                                    <input type="text" id="basic-icon-default-notes" class="form-control"
                                        placeholder="Enter notes Name" aria-label="notes"
                                        aria-describedby="basic-icon-default-notes2" name="title" />
                      ...
                      <div class="mb-3">
                        ...
                        <select id="defaultSelect" class="form-select" name="category_id" required>
                          ...
                          <option value={{ $cat->id }} {{ $cat->name=="Notes"?"selected":"" }}>{{ $cat->name }}</option>
                          @endforeach
                        </select>
                        <div class="span text-danger">
                                    @error('category_id')
