...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Books/</span> Create
            ...
            <div class="col-xl-8 mx-auto">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Create A New Books</h5>
                    </div>
                    <div class="card-body">
                        <form action ="/books" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label" for="basic-icon-default-books">Book</label>
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-books2" class="input-group-text"><i
                                            class="bx bx-buildings"></i></span>
                                    <input type="text" id="basic-icon-default-books" class="form-control"
                                        placeholder="Enter books Name" aria-label="books"
                                        aria-describedby="basic-icon-default-books2" name="title" />
                      ...
                      <div class="mb-3">
                        ...
                        <select id="defaultSelect" class="form-select" name="category_id" required>
                          ...
                          <option value={{ $cat->id }} {{ $cat->name=="Books"?"selected":"" }}>{{ $cat->name }}</option>
                          @endforeach
                        </select>
                        <div class="span text-danger">
                                    @error('category_id')
