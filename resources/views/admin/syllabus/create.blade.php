...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Syllabus/</span> Create
            ...
            <div class="col-xl-8 mx-auto">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Create A New Syllabus</h5>
                    </div>
                    <div class="card-body">
                        <form action ="/syllabus" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="basic-icon-default-syllabus" class="form-control"
                                        ...
                                        aria-describedby="basic-icon-default-syllabus2" name="title" />
